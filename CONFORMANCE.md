...
Implementations in other languages should pass the fixture suite before claiming Draft 0.4 support.
...
A conforming Draft 0.4 renderer must compile PageScript IR to standalone HTML/CSS/SVG and support:
